...
if(is_post_request()) {
  ...
  if($result === true){
      redirect_to(url_for('employee/subjects/show.php?id=' . $id));
  }
  else{
    $errors = $result;
    //var_dump($errors);
...
<div id="content">
  ...
  <div class="subject edit">
    ...
    <form action="<?php echo url_for('/employee/subjects/edit.php?id=' . h(u($id))); ?>" method="post">
      <dl>
        <dt>Menu Name</dt>
      ...
      <dl>
        <dt>Content</dt>
        <dd>
          <textarea name="content" cols="100" rows="10"><?php echo h($subject['content']); ?></textarea>
        </dd>
      </dl>
      <div id="operations">
        <input type="submit" value="Edit Nav Item" />
      </div>
    </form>
