...
if(is_post_request()){
  ...
  if($result === true){
    ...
    redirect_to(url_for('/employee/subjects/show.php?id=' . $new_id));
  }
  else{
    $errors = $result;
  }
...
<div id="content">
  ...
  <div class="subject new">
    ...
    <form action="<?php echo url_for('/employee/subjects/new.php'); ?>" method="post">
      <dl>
        <dt>Menu Name</dt>
      ...
      <div id="operations">
        <input type="submit" value="Create Nav Item" />
      </div>
    </form>
