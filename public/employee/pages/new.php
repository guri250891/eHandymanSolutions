...
if(is_post_request()) {
 ...
 $page = [];
  ...
  redirect_to(url_for('/employee/pages/show.php?id=' . $new_id));
  }
  else{
    $errors = $result;
  }
...
<?php $page_title = 'Create Sub Nav Item'; ?>
...
<div id="content">
  ...
  <div class="page new">
    <h1>Create Sub Nav Item</h1>

    <?php echo display_errors($errors); ?>

    <form action="<?php echo url_for('/employee/pages/new.php'); ?>" method="post">
      <dl>
        <dt>Main Nav Item</dt>
        <dd>
      ...
      <div id="operations">
        <input type="submit" value="Create Sub Nav Item" />
      </div>
    </form>
