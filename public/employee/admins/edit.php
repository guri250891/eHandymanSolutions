...
require_login();
if(!isset($_GET['id'])) {
  redirect_to(url_for('/employee/admins/index.php'));
}
$id = $_GET['id'];
...
if(is_post_request()) {
  ...
  if($result === true) {
    ...
    redirect_to(url_for('/employee/admins/show.php?id=' . $id));
  } else {
    $errors = $result;
  }
} else {
...
<div id="content">
  ...
  <div class="admin edit">
    ...
    <form action="<?php echo url_for('/employee/admins/edit.php?id=' . h(u($id))); ?>" method="post">
      <dl>
        <dt>Username</dt>
